...
const offersList = Array(10).fill({
  ...
  image: "https://s56442.cdn.ngenix.net/api/ext/svg-data/svg/rshb/services/images/invest_kredit.svg",
  info: [
    "Аванс от 10%",
    "Срок до 60 месяцев",
    "Техника и оборудование на специальных условиях, в том числе с использованием мер государственной поддержки",
  ],
});
</script>
        ...
        <swiper-slide v-for="item in offersList" class="bg-white rounded-xl p-8">
          <div class="flex flex-col items-center justify-between">
            <div class="flex flex-col items-center">
              ...
              <ul class="offer-info-list flex flex-col gap-4 mt-6">
                <li v-for="child in item.info" class="offer-info-item font-light leading-[1.8]">{{ child }}</li>
              </ul>
            </div>

            <button class="border-2 border-gray-300 rounded-full text-sm w-full py-3 px-6 mt-8 hover:border-gray-400">Подробнее</button>
          </div>
        </swiper-slide>
      </swiper>
