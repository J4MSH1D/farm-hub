...
<template>
  <div class="container py-8">
    <ul>
      <li v-for="item in filteredCredits" class="flex justify-between bg-white rounded-xl px-8 py-7 mb-5">
        <div class="grid grid-cols-[40%,30%,30%] gap-5 w-full px-5">
          <div>
            ...
            <h3 class="text-lg text-zinc-900 font-medium mt-2">{{ item.name?.[locale] }}</h3>
          </div>
          <!-- credit-info -->
